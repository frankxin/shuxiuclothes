    ...
    <div class="pure-g-r bucket-main">
        <div class="pure-u-1 bucket-main-table">
            ...
            <table class="bucket-table bucket-goods">
                <tbody>
                    <?php if(is_array($cartReturn)): $i = 0; $__LIST__ = $cartReturn;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="bucket-goods-tr">
                        <td class="th1">
                            <span><?php echo ($vo["description"]); ?></span>
                        </td>
                        <td class="th2"><?php echo ($vo["price"]); ?></td>
                        <td class="th3"><?php echo ($vo["countTime"]); ?></td>
                        <td class="th4"><?php echo ($vo["countPrice"]); ?></td>
                        <td class="th5">
                            <button class="deleteGoods" <?php echo U("Order/delete",array("id"=>$vo['id']));?>>删除</button>
                        </td>
            ...
            <div class="bucket-submit">
                <button class="my-button" href="<?php echo U('Order/order');?>">提交订单</button>
            </div>
        </div>
    </div>

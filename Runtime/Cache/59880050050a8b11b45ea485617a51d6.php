	...
	<div class="content">
		<div class="info-list">
                <ul class="zzx_list_style">
                    <?php if(is_array($contentsData)): $i = 0; $__LIST__ = $contentsData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                            <span class="zzx_form_c">
                             [
                             <a href="#"><?php echo ($name); ?></a>
                             ]
                            </span>
                            <a href="<?php echo U("SPage/view",array("cat"=>$vo['cid'],"cont"=>$vo['aid']));?>" class="zzx_title"><?php echo ($vo["title"]); ?></a>
                            <cite class="zzx_time"><?php echo (date("Y-m-d H:i",$vo["inputtime"])); ?></cite>

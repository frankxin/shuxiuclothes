...
// 			url: 'www.taobao.com',
// 			status: 1,
// 			title: 'VISIBLE Space Storm满版绣花POLO衫',
// 			pic: "img/test.jpg"
// 		}, {
// 			numbers: 1,
// 			oriPrice: 500,
...
function creatDom() {
	...
	var item = "<tr class=\"on-goods\"><td><div class=\"bucket-img\"><input type=\"checkbox\" checked=\"\"><a href=\"#\"><img src=\"\" width=\"60px\" height=\"60px\"></a><p><a href=\"#\"><b></b></a><br><span class=\"detail-s\"></span></p></div></td><td><p>拼单价：<span class=\"pd-price\"></span></p><p>淘宝价：<span class=\"tb-price\"></span></p></td><td class=\"count-box\"><a href=\"javascript:;\" class=\"J_minus\">-</a><input type=\"text\" value=\"\" disabled=\"disabled\" class=\"J_input\"><a href=\"javascript:;\" class=\"J_add\">+</a></td><td><strong class=\"total\">￥218.00 </strong></td><td><button>删除</button></td></tr>";
...
function countTotal() {
	...
	for (var i = 0; i < onGoods.length; i++) {
		if(($(".on-goods .bucket-img input:eq("+i+")").prop("checked"))==true){
			...
			$(".price span:eq(1)").text("￥" + (oriTotal.toFixed(2) - total.toFixed(2)));
...
function batDel() {
	$(".bucket-batch a").click(function() {
		...
		$.post("php/bucketfunction.php",{func:"deleteGoods",goodssid:goodssid});
	})
}
...
function judgeIsNull(){
	...
	var $btn = $(".my-button");
	var pic = "<div class=\"emptybucket\"><img src=\"../Public/images/emptybucket.jpg\"></div>";
...
function finish(){
	$(".my-button").click(function(){
		...
		$.post("php/bucketfunction.php",{func:"BuyBucket",goods:goodsID,num:num});
